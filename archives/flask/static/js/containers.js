...
var containers = {
    ...
    url: {
        get: 'http://127.0.0.1:4000/containers'
    },
    sortData: [
        ...
        case 'action:stop':
            if (record == null) {
                ...
                w2confirm(msg, "Stop Container", function btn(answer) {
                    ...
                    switch (answer) {
                        case 'Yes':
                            $.get("http://127.0.0.1:4000/containers/" + record.Id + '/stop', function () {
                            })
                                .done(function () {
        ...
        case 'action:remove' :
            if (record == null) {
                ...
                w2confirm(msg, "Remove Container", function btn(answer) {
                    ...
                    switch (answer) {
                        case 'Yes':
                            $.get("http://127.0.0.1:4000/containers/" + record.Id + '/remove', function () {
                            })
                                .done(function () {
